...
public class Test3 {
    ...
    public static void main(String[] args) {
        ...
        DateTime dateTime2 = new DateTime("2018-08-06");
        ...
        DateTime dateTime5 = new DateTime("2018-10-07");
        Summary summary5 = new Summary(dateTime5.toDate(), 19, 20);

        DateTime dateTime6 = new DateTime("2018-10-05");
        Summary summary6 = new Summary(dateTime6.toDate(), 19, 20);

        DateTime dateTime7 = new DateTime("2018-07-28");
        ...
        for (Summary summary : summaries) {
            String month = String.valueOf(new DateTime(summary.getDate()).monthOfYear().get());
            if (map.keySet().contains(month)) {
                map.get(month).add(summary);
            } else {
                map.put(month, Lists.newArrayList(summary));
            }
        }
        ...
        points.sort(Comparator.comparingInt(o -> Integer.valueOf(o.getDate())));
